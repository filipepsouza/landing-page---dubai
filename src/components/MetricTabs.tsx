        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="md:col-span-7 flex flex-col items-start text-left">
              ...
              <button 
                onClick={onCtaClick}
                className="relative group px-6 py-3.5 bg-gradient-to-r from-[#0B5D3B] via-[#12A56B] to-[#0B5D3B] text-black font-cinzel text-[10px] font-black tracking-widest rounded-full transition-all duration-300 hover:scale-105 overflow-hidden cursor-pointer shadow-[0_0_20px_rgba(18, 165, 107,0.25)] hover:shadow-[0_0_35px_rgba(18, 165, 107,0.55)]"
              >
